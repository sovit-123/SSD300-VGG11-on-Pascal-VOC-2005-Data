...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', default='../input/test_data/horse.jpg',
                        help='path to the test data')
    parser.add_argument('-c', '--checkpoint', default='../model_checkpoints/checkpoint_ssd300_vgg16.pth.tar', 
